...
- `parseCareerRelationVerdicts()` + wire:
  ...
  - (boss table extract ไว้แล้ว ยังไม่ wire — "ตัวเรา>เจ้านาย" คือเราต่อเจ้านาย ไม่ตรงบท4 อุปถัมภ์ตรงๆ)
- ตัวอย่าง: สิริกัญญา บริวารเซียงแซหมกยก → "มักสร้างปัญหาให้แก้ไข แต่ถ้าใช้ถูกวิธี…". golden 0 regression

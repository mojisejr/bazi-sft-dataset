...
/* รูปแมนิเฟสต์ย้ายไปเก็บใน DB เดียวกับการ์ด (ตาราง bazi_manifest_photo) แล้ว — ไม่ใช้ Supabase Storage
   อีกต่อไป ดู src/app/api/manifest/photo/route.ts. ฟังก์ชัน bucket แมนิเฟสต์เดิมถูกลบทิ้ง (dead code). */

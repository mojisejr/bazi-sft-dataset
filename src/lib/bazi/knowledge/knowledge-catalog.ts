...
import {
  ...
  ELEMENT_DEITY_NEGOTIATION_TH,
  ELEMENT_DEITY_WEALTH_TH,
  ELEMENT_DIRECTION_TH,
  ELEMENT_HEALTH_BEHAVIOR_TH,
  ELEMENT_IMAGERY_TH,
  ELEMENT_MONEYTOOL_TH,
  ELEMENT_SHAPE_TH,
...
export const KNOWLEDGE_CATALOG: readonly KnowledgeCatalogEntry[] = [
  ...
  { tableId: "ELEMENT_CLOTHING_TH", label: "บท 14 · เสื้อผ้า/เครื่องแต่งกาย ตามธาตุ", keyKind: "element", defaults: ELEMENT_CLOTHING_TH },
  { tableId: "ELEMENT_MONEYTOOL_TH", label: "บท 14 · กระเป๋า/เคส/เครื่องมือหาเงิน ตามธาตุ", keyKind: "element", defaults: ELEMENT_MONEYTOOL_TH },
  ...
  { tableId: "ELEMENT_DEITY_NEGOTIATION_TH", label: "บท 15 · องค์เทพขอพร เจรจา/ทำงาน/ลงทุน/เดินทาง ตามธาตุ", keyKind: "element", defaults: ELEMENT_DEITY_NEGOTIATION_TH },
  { tableId: "ELEMENT_DEITY_WEALTH_TH", label: "บท 15 · องค์เทพขอพร โชคลาภ/เงินเก็บ ตามธาตุ", keyKind: "element", defaults: ELEMENT_DEITY_WEALTH_TH },

...
export const CHAPTER_BULLET_RESOLVERS: Record<string, Resolver[][]> = {
  ...
  // 5 bullets: [ธาตุส่งเสริม] [คู่ธาตุ] [ธาตุถ่ายเท/บริวาร] [ธาตุโชคลาภ/ลูกค้า] [หุ้นส่วน]
  ...
  love_partner: [
    // ลักษณะชีวิตคู่ = 60 box ตามกะจื่อหลักวัน (ราศีบน-ล่าง) + ความรู้คู่ครอง 60 (กล่องใหม่ ซินแสเติมในแอดมิน) + ภาคีราศีล่าง
    [
      { kind: "ganzhiOf", group: "love_base_60", pillar: "day" },
      { kind: "ganzhiOf", group: "spouse_knowledge_60", pillar: "day" },
      { kind: "branchPairs", group: "combine_branch" },
    ],

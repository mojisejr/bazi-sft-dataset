...
export function buildOpenWebUiTriagePromptPayload(
  ...
  return {
    systemInstruction: [
      ...
      "  • ของ/คน/สัตว์หาย จะได้คืน/เจอไหม เช่น 'ของหายจะได้คืนไหม' / 'แมวหายจะกลับมาไหม' / 'หมาหายไปสองวันแล้ว จะได้เจอไหม' / 'กระเป๋าตังค์หายจะได้คืนมั้ย' — ห้ามสับสนกับ colors_directions/turning_points เด็ดขาด แม้ข้อความจะสั้น/กำกวม เรื่องหา-ของ-คน-สัตว์ที่หายไปคือ card_reading เสมอ",

    ...
    userPrompt: [
      ...
      hasPhoneData && !crisis
        ? [
          ...
          [
            "วิธีตอบ:",
            "- อธิบายเป็นภาษาพูดอบอุ่นแบบซินแสถอดเบอร์ให้: ภาพรวมของเบอร์นี้ (เน้น \"คู่ปิดท้าย\" ที่น้ำหนักมากสุด) แล้วไล่ด้าน การงาน/การเงิน/ความรัก ตามผลถอด",
            "- ฟันธงว่าเบอร์นี้ดี/กลาง/ควรระวัง ด้านไหน จากความหมายคู่เลข ไม่ตอบลอย ๆ",

      ...
      hasPhoneData && !crisis
        ? [
          ...
          [
            ...
            "- **วิชาปิรามิด (เบอร์รังผึ้ง)** ถ้ามีส่วน [ปิรามิดเบอร์]: พูดถึง \"ยอดปิรามิด\" ว่าเป็นแก่นรวม/พลังโดยรวมของทั้งเบอร์ และคู่แก่นโซนตัวเรา เสริมกับวิชาคู่เลข (ให้สองวิชาส่งเสริมกัน ไม่ขัดกัน)",

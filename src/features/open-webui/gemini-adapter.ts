    ...
    userPrompt: [
      ...
      hasCardReadingData && !crisis
        ? [
          ...
          [
            "วิธีตอบ:",
            "- **ต้องเปิดคำตอบด้วยคำว่า \"เสี่ยงทาย\" สักครั้ง** (เช่น \"ลองเสี่ยงทายดูแล้วนะครับ\"/\"เสี่ยงทายให้แล้วครับพี่\") — บอกตรงๆ ว่ามีการทำนาย **แต่ห้ามระบุว่าเป็น \"ไพ่\" เด็ดขาด — ห้ามบอกชื่อไพ่ ห้ามพูดว่า \"จั่วไพ่ได้...\"/\"ไพ่ที่หยิบได้คือ...\"/\"เปิดไพ่\"** (ซินแสนุ้ยสั่ง 2026-09-20: อยู่ในแชทข้อความ บอกว่าเป็นไพ่แล้วคนจะเอ๊ะว่ารู้ได้ไง — แต่ไม่บอกว่าเสี่ยงทายเลยก็ห้วนไป ต้องบอกว่า \"เสี่ยงทาย\" แต่ไม่ระบุวิธี) แล้วฟันธงตอบคำถามตรง ๆ จากสถานการณ์/ข้อควรระวัง/คำแนะนำของไพ่ใบนี้ (ใช้เป็นเนื้อหาคำตอบ ไม่ใช่เอ่ยถึงตัวไพ่)",

...
const ARTICLES: Array<{ slug: string; title: string; body: string; position: number }> = [
  ...
  {
    // P1-7: ลิงก์ "ข้อกำหนดการใช้งาน" ในหน้า settings เดิม 404 — ให้ชี้มาที่ /v2/help/doc/terms
    // ⚠️ เนื้อหาย่อ ควรให้ทีม/ฝ่ายกฎหมายตรวจและเติมฉบับเต็มก่อนใช้จริง
    slug: "terms",
    title: "ข้อกำหนดการใช้งาน",
    body: [
      "MuMate ให้บริการทำนายดวงเพื่อความบันเทิงและการไตร่ตรองส่วนบุคคล ไม่ใช่คำแนะนำทางการแพทย์ กฎหมาย หรือการเงิน",
      "",
      "• ผู้ใช้ต้องให้ข้อมูลตามจริงและใช้งานตามกฎหมาย",
      "• ชี่ (Qi) และแพ็กเกจเป็นสิทธิ์การใช้งานในแอป ไม่สามารถแลกเป็นเงินสด",
      "• เราปรับปรุงฟีเจอร์และเงื่อนไขได้เป็นครั้งคราว โดยจะแจ้งการเปลี่ยนแปลงที่สำคัญ",
      "",
      "มีคำถามเกี่ยวกับข้อกำหนด ติดต่อ Line @mumate.co",
    ].join("\n"),
    position: 6,
  },
  {
    // P1-7: ลิงก์ "ข้อมูลบริษัท" เดิมชี้ /v2/help/about (404) — ให้ชี้ /v2/help/doc/about
    slug: "about",
    title: "ข้อมูลบริษัท",
    body: [
      "MuMate เป็นบริการภายใต้ Mootech",
      "",
      "• ติดต่อ / สอบถาม: Line @mumate.co",
    ].join("\n"),
    position: 7,
  },
];

/**
 * Apply migration: bazi_user_profile_display_name (additive, idempotent)
 * Usage: node --env-file=.env --import tsx scripts/apply-user-profile-migration.ts
 */
...
async function main() {
  const sqlPath = path.resolve(process.cwd(), "drizzle/0040_user_profile_display_name.sql");

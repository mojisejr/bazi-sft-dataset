/**
 * Apply migration: bazi_user_intent — เก็บ onboarding intent ต่อ anonId (additive, idempotent)
 * Usage: node --env-file=.env --import tsx scripts/apply-user-intent-migration.ts
 */
...
async function main() {
  ...
  console.log("OK table bazi_user_intent columns:");
  for (const r of rows) {

...
describe("symbolic-engine fact shell", () => {
  ...
  test("returns exact deterministic payloads for the pinned reference chart", async () => {
    ...
    expect(facts).toEqual([
      ...
      expect.objectContaining({ dependency: "pillar_relations", resolved: true, summary: "壬戊 [heavenly-stem-clash], 巳申 [earthly-branch-liu-he], 巳申 [earthly-branch-liu-he], 巳申 [earthly-branch-destruction], 巳申 [earthly-branch-destruction], 寅巳申 [earthly-branch-punishment], 巳申亥 [earthly-branch-punishment], 壬x巳 [element-control], 申->壬 [element-generate], 戊x壬 [element-control], 戊->申 [element-generate], 戊->申 [element-generate], 戊->辛 [element-generate], 申->壬 [element-generate], 己x壬 [element-control], 己->申 [element-generate], 己->申 [element-generate], 己->辛 [element-generate], 巳x申 [element-control], 巳->戊 [element-generate], 巳x申 [element-control], 巳->己 [element-generate], 巳x辛 [element-control], 巳->未 [element-generate], 辛->壬 [element-generate], 未x壬 [element-control], 未->申 [element-generate], 未->申 [element-generate], 未->辛 [element-generate]" }),
      expect.objectContaining({ dependency: "month_branch_relations", resolved: true, summary: "巳申 [earthly-branch-liu-he], 巳申 [earthly-branch-destruction], 寅巳申 [earthly-branch-punishment], 巳申亥 [earthly-branch-punishment], 戊->申 [element-generate], 申->壬 [element-generate], 己->申 [element-generate], 巳x申 [element-control], 未->申 [element-generate]" }),
      expect.objectContaining({ dependency: "day_branch_relations", resolved: true, summary: "巳申 [earthly-branch-liu-he], 巳申 [earthly-branch-liu-he], 巳申 [earthly-branch-destruction], 巳申 [earthly-branch-destruction], 寅巳申 [earthly-branch-punishment], 巳申亥 [earthly-branch-punishment], 壬x巳 [element-control], 巳x申 [element-control], 巳->戊 [element-generate], 巳x申 [element-control], 巳->己 [element-generate], 巳x辛 [element-control], 巳->未 [element-generate]" }),

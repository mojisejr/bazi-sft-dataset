...
describe("buildSemanticChamberGraph", () => {
  ...
  test("emits four semantic pillar nodes with stage slots and the day pillar focal", () => {
    ...
    expect(focal?.data.kind === "pillar" ? focal.data.stageSlots.length : 0).toBeGreaterThan(0);
  });
